      ...
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center items-center  gap-8">
        ...
        <div className="my-4 sm:w-[70%] w-full">
          <div className="flex flex-col items-center md:flex-row w-full">
            <input
              className="text-black p-2 md:p-4 w-full rounded-md sm-w-[70%]"
              type="email"
              placeholder="輸入您的Email"
            />
            <button className="  text-black  text-md bg-[#9370b2] w-full md:w-[200px] md:ml-4 px-auto py-2 md:py-4 rounded-md font-medium mt-4 md:mt-0">
              訂閱
            </button>
          </div>
        </div>
